						...
						<div className="blog-post-details">
							...
							<div className="row tag-share-wrap mt-4 mb-5">
								<div className="col-lg-8 col-12">
									<div className="tagcloud">
										<span>Tags:</span>
										<Link to="/news-details">Travel</Link>
										<Link to="/news-details">Services</Link>
							...
							<div className="comments-area">
								...
								<div className="blog-single-comment d-flex gap-4 pt-4 pb-5">
									<div className="image">
										<img src="assets/img/news/comment-1.png" alt="user avatar" />
									</div>
								...
								<div className="blog-single-comment d-flex gap-4 pt-5 pb-5">
									...
									<div className="content">
										...
										<Link to="/news-details" className="reply color-2">
											Reply
										</Link>
									</div>
								</div>
							...
							<div className="single-sidebar-widget">
								...
								<div className="news-widget-categories">
									<ul>
										...
										<li>
											<Link to="/news-details">Shipment Solutions </Link>{" "}
											<span>2</span>
										</li>
										<li>
